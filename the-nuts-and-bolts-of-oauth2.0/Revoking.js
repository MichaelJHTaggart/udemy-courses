// Revoking access to Protected Resource (Logging out)


// 1. Make sure that the client_id & client_secret belong to the Client application (*Not the Protected Resource)

/*

curl https://dev-49617478.okta.com/oauth2/default/v1/revoke \
